...
public class QuestionsAndAnswersTest extends AbstractTest{
    private final int questionNumber;
    private final String answerText;
    public QuestionsAndAnswersTest(int questionNumber, String answerText){
        this.questionNumber = questionNumber;
        this.answerText = answerText;
    }
    @Parameterized.Parameters
    public static Object[][] getAnswersData() {
        return new Object[][] {
    ...
    public void openAnswerTest() {
        new MainPage(getWebDriver())
                .checkAnswerIsHidden(questionNumber)
                .clickQuestionButton(questionNumber)
                .checkAnswerIsDisplayedWithText(questionNumber, answerText);
    }
}
